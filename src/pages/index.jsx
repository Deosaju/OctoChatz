              ...
              <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
                <div className="relative pt-24 ml-auto">
                  <div className="lg:w-2/3 text-center mx-auto">
                    ...
                    <p className="mt-8 text-gray-700 dark:text-gray-300">Octochat will provide the one single thing most of github users need !</p>
                    <p className="mt-8 text-gray-700 dark:text-gray-300">Social media to connect with github contributors</p>
                    <div className="mt-16 flex flex-wrap justify-center gap-y-4 gap-x-6">
                      <button onClick={redirectToGithub} className="relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max"
                      >
                        <a
                        >
                      ...
                      <a
                        href="https://github.com/Deosaju/OctoChatz"
                    ...
                    <div className="hidden py-8 mt-16 border-y border-gray-100 dark:border-gray-800 sm:flex justify-between">
                      <div className="text-left">
                        <h6 className="text-lg font-semibold text-gray-700 dark:text-white">The Opensource</h6>
                      </div>
                      <div className="text-left">
                        <h6 className="text-lg font-semibold text-gray-700 dark:text-white">The first on the Internet</h6>
                      </div>
                      <div className="text-left">
