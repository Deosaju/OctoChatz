                        ...
                        <tr key={follower.login}>
                          <td className="p-2 whitespace-nowrap">
                            <div className="flex items-center">
                              ...
                              <Link href={`/People/?searchUser=${follower.login}`}><div className="font-medium text-white">{follower.login}</div></Link>
                            </div>
                          ...
                          <td className="p-2 whitespace-nowrap">
                            <button href="#" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" >Add friend</button>
                          </td>
                        </tr>
                      ))}
                    </tbody>
