                    ...
                    <tbody className="text-sm divide-y divide-gray-100">
                      {followers && followers.map((follower) => (
                        <tr key={follower.login}>
                          ...
                          <td className="p-2 whitespace-nowrap">
                            <button href="#" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-red-600 dark:hover:bg-red-800 dark:focus:ring-red-900" >UnFriend</button>
                          </td>
                          <td className="p-2 whitespace-nowrap">
